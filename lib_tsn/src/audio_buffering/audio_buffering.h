...
struct output_finfo {
    void *unsafe p_buffer[AVB_NUM_MEDIA_OUTPUTS];
};
...
typedef enum audio_io_t { AUDIO_I2S_IO, AUDIO_TDM_IO } audio_io_t;
...
audio_buffers_swap_active_buffer0(audio_double_buffer_t &buffer) {
    volatile audio_double_buffer_t *unsafe p_buffer =
        (volatile audio_double_buffer_t * unsafe)(&buffer);
