...
void begin_write_upgrade_image(void) { write_offset = 0; }

void abort_write_upgrade_image(void) { write_offset = -1; }

int avb_write_upgrade_image_page(int address, uint8_t data[FLASH_PAGE_SIZE], uint16_t &status) {
