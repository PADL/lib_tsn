...
char *debug_mrp_registrar_state[] = {"MRP_IN", "MRP_LV", "MRP_MT"};

char *debug_mrp_event[] = {"MRP_EVENT_BEGIN",
                           "MRP_EVENT_NEW",
                           "MRP_EVENT_FLUSH",
                           "MRP_EVENT_JOIN",
                           "MRP_EVENT_LV",
...
char *debug_attribute_type[] = {"MSRP_TALKER_ADVERTISE",  "MSRP_TALKER_FAILED", "MSRP_LISTENER",
                                "MSRP_DOMAIN_VECTOR",     "MMRP_MAC_VECTOR",    "MVRP_VID_VECTOR",
